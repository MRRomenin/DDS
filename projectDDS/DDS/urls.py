...
urlpatterns = [
    ...
    # Адрес для удаление и добавление категорий
    ...
    # Адрес для удаление и добавление подкатегорий
